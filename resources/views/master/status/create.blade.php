        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Formulir Tambah Status</h4>
                    <p class="card-text mb-0">
                        Silakan isi data status baru di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="Nama"
                                    ...
                                    placeholder="Nama Status" value="{{ old('Nama') }}">
                                @error('Nama')
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="Deskripsi" id="Deskripsi" class="form-control @error('Deskripsi') is-invalid @enderror" rows="4"
                                    placeholder="Deskripsi Status">{{ old('Deskripsi') }}</textarea>
                                @error('Deskripsi')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
