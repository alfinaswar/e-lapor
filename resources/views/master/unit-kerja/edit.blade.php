        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Formulir Edit Unit Kerja</h4>
                    <p class="card-text mb-0">
                        Silakan edit data unit kerja di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                    <form action="{{ route('master-unit-kerja.update', ['master_unit_kerja' => encrypt($data->id)]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="Nama"
                                    ...
                                    placeholder="Nama Unit Kerja" value="{{ old('Nama', $data->Nama) }}">
                                @error('Nama')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="KodeUnit"
                                    ...
                                    placeholder="Kode Unit" value="{{ old('KodeUnit', $data->KodeUnit) }}">
                                @error('KodeUnit')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="Deskripsi" id="Deskripsi" class="form-control @error('Deskripsi') is-invalid @enderror" rows="4"
                                    placeholder="Deskripsi Unit Kerja">{{ old('Deskripsi', $data->Deskripsi) }}</textarea>
                                @error('Deskripsi')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
